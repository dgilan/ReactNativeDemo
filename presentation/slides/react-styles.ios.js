...
import Lang from '../language/react-styles.en'
        ...
        return (
            <View style={[styles.content, styles.root]}>
                <View style={styles.center}>
                    ...
                    <Heading size={3} style={styles.header}>{Lang.STYLES}</Heading>
                </View>

                <Image source={image} style={{width: width - 10, height: height/2, marginBottom: 40}}
                       resizeMode="contain"/>
            </View>
        );
    }
